...
<img src="GDCRtools_logo.png" align="center" width="346" height="50"/>
...
<img src="VIGNETTE-package_flow.png" align="center" width="595" height="842"/>
...
The downloaded files are individualized by patients. All next analysis In the example below:d by **GDCRtools** require the values organized in a single table (object). This requirement can be achieved by running the `concatenate_files()` function. See `help("concatenate_files")` for more information.
...
Alternatively, it is possible to use more than one DEA package. When the case, **GDCRtools** In the example below:s `CrossThem()`. This function executes a Venn diagram, returning only one consensus list of genes between the DEA packages. This consensus genes list can be used in Pathway Enrichment Analysis workflow step. See `help("CrossThem")` for more information about the applicable parameters.
...
``` 
<img src="VIGNETTE-mixture_log2_expression_1.png" align="center" width="667" height="500"/>
...
``` 
<img src="VIGNETTE-VolcanoPlot_Basic_G3_over_G1.png" align="center" width="667" height="500"/>
...
``` 
<img src="VIGNETTE-PCA_GENETOP=all_G2_over_G1.png" align="center" width="638" height="388"/>
...
``` 
<img src="VIGNETTE-euclidean_average_row_FC.cutoff=2_G2_over_G1.png" align="center" width="595" height="842"/>
...
<img src="VIGNETTE-enrichGO_smallest_FDR_Ont_BP_upregulated_GeneID_G2_over_G1.png" align="center" width="600" height="600"/>
